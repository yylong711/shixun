...
class Preprocessor:
    ...
    def load_feature_model(self, filename='/Users/fanjialiang2401/Desktop/项目实训/VENV_shixun/shixun/emotion_analyze/model/feature.json'):
        with codecs.open(filename, 'r', 'utf-8') as f:
            self.features = json.loads(f.read())

    def sentence2vec(self, word_list):
    ...
    def loan_stopwords(self):
        stopwords = []
        with codecs.open('/Users/fanjialiang2401/Desktop/项目实训/VENV_shixun/shixun/emotion_analyze/corpus/stopwords.txt', 'r', 'utf-8') as f:
